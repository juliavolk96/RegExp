...
describe('formatPhoneNumber', () => {
  test('должен форматировать номер телефона в формате 8 (927) 000-00-00', () => {
    const phoneNumber = '8 (927) 000-00-00';
    const formattedNumber = formatPhoneNumber(phoneNumber);
    expect(formattedNumber).toBe('+7 927 000 00 00');
  });

  test('должен форматировать номер телефона в формате +7 960 000 00 00', () => {
    const phoneNumber = '+7 960 000 00 00';
    const formattedNumber = formatPhoneNumber(phoneNumber);
    expect(formattedNumber).toBe('+7 960 000 00 00');
  });

  test('должен форматировать номер телефона в формате +86 000 000 0000', () => {
